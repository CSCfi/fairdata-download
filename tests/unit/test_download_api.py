...
class TestGetDownload:
    ...
    def test_download_unauthorized(self, client, available_dataset):
        query_string = {
            'dataset': available_dataset['pid'],
            'package': available_dataset['package']
        }
    ...
    def test_download_invalid_auth_type(self, client, available_dataset):
        query_string = {
            'dataset': available_dataset['pid'],
            'package': available_dataset['package']
        }
    ...
    def test_download_empty_token(self, client, available_dataset):
        query_string = {
            'dataset': available_dataset['pid'],
            'package': available_dataset['package']
        }
    ...
    def test_download_expired_token(self, client, expired_auth_token, available_dataset):
        query_string = {
            'dataset': available_dataset['pid'],
            'package': available_dataset['package']
        }
    ...
    def test_download_non_found_package(self, client, not_found_dataset, not_found_dataset_auth_token):
        query_string = {
            'dataset': not_found_dataset['pid'],
            'package': 'test.zip'
        }
    ...
    def test_download_invalid_token(self, client, invalid_auth_token, available_dataset):
        query_string = {
            'dataset': available_dataset['pid'],
            'package': available_dataset['package']
        }
