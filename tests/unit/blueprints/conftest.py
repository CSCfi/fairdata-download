...
def get_matching_dataset_files_connection_error(monkeypatch):
    ...
    monkeypatch.setattr(
        "download.services.metax.get_matching_dataset_files_from_metax",
        _get_matching_dataset_files_connection_error,
    )
...
def get_matching_dataset_files_unexpected_status_code(monkeypatch):
    ...
    monkeypatch.setattr(
        "download.services.metax.get_matching_dataset_files_from_metax",
        _get_matching_dataset_files_unexpected_status_code,
    )
